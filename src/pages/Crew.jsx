...
export default function Crew({ data }) {
    ...
    return (
        <section className='crew-page container-fluid pb-1'>
            ...
            <div className='crew-container container d-flex flex-column flex-lg-row justify-content-evenly justify-lg-between align-items-center'>
                ...
                <article className='crew-content container d-flex flex-column justify-content-center order-md-2'>
                    ...
                    <div className='crew-details order-md-1'>
                        <header>
                            <h2 className='subheading-1 text-center crew-role pb-3'>{data[activeTab].role}</h2>
                            <h3 className='subheading text-center crew-name pb-4'>{data[activeTab].name}</h3>
                        </header>
                        <p className='crew-bio body-text text-center px-4 px-md-5'>{data[activeTab].bio}</p>
                    </div>
                </article>
