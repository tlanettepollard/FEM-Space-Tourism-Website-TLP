    ...
    return (
        <section className='destination-page '>
            ...
            <div className='d-flex flex-column justify-content-start align-items-center container'>
                ...
                <article className='dest-image-container'>
                ...
                <article className='container dest-content mb-5'>
                    <ButtonContainer
                        name={'destinations'}
                        data={data}
                        activeTab={activeTab}
                    ...
                    <div className='dest-details-container mb-5'>
                        <div className='dest-details borderTop'>
